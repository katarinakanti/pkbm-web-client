...
//                       handleInputChange("application_type", Array.from(keys)[0])
//                     }
//                   >
...
//                     isRequired
//                     selectedKeys={
//                       formData.student_status ? [formData.student_status] : []
//                     }
//                     onSelectionChange={(keys) =>
//                       handleInputChange("student_status", Array.from(keys)[0])
//                     }
//                   >
//                     <SelectItem key="BARU">Baru</SelectItem>
//                     <SelectItem key="MUTASIPINDAHAN">
//                       Mutasi/Pindahan
//                     </SelectItem>
//                   </Select>
...
//                     onValueChange={(value) =>
//                       handleInputChange("asal_sekolah", value)
//                     }
//                   />
...
//                       onValueChange={(value) =>
//                         handleInputChange("alasan_pindah", value)
//                       }
//                     />
//                   )}
//                 </div>
...
//                     onValueChange={(value) =>
//                       handleInputChange("parent_fullname", value)
//                     }
//                   />
//                   <Input
...
//                     onValueChange={(value) =>
//                       handleInputChange("parent_phone", value)
//                     }
//                   />
//                   <Input
//                     label="Email Aktif"
...
//                     onValueChange={(value) =>
//                       handleInputChange("parent_email", value)
//                     }
//                   />
//                 </div>
//               )}
...
//               Pilih dari siswa tersimpan atau tambah siswa baru
//             </p>
//           </ModalHeader>
//           <ModalBody>
//             <RadioGroup
...
//                               <div>
//                                 📅{" "}
//                                 {moment(applicant.birth_date).format(
//                                   "DD MMMM YYYY"
//                                 )}
//                               </div>
//                             </div>
...
//                     onValueChange={(value) =>
//                       setNewApplicant({ ...newApplicant, fullname: value })
//                     }
//                   />
//                   <Input
//                     label="Email"
...
//                     onValueChange={(value) =>
//                       setNewApplicant({ ...newApplicant, phone_number: value })
//                     }
//                   />
//                   <RadioGroup
//                     label="Jenis Kelamin"
...
//                     onValueChange={(value) =>
//                       setNewApplicant({ ...newApplicant, birth_place: value })
//                     }
//                   />
//                   <Input
//                     label="Tanggal Lahir"
...
//                     selectedKeys={
//                       newApplicant.religion ? [newApplicant.religion] : []
//                     }
//                     onSelectionChange={(keys) =>
//                       setNewApplicant({
//                         ...newApplicant,
//                         religion: Array.from(keys)[0] as string,
//                       })
//                     }
//                   >
...
//                     onValueChange={(value) =>
//                       setNewApplicant({ ...newApplicant, address: value })
//                     }
//                   />
//                 </div>
//               </div>
